...
![GitHub release (latest by date)](https://img.shields.io/github/downloads/gbv/SignaturenDruck/v1.3.22/total?label=downloads@v1.3.22)  
<!---
...
- SRU-Bugfixes ([#114](https://github.com/gbv/SignaturenDruck/issues/114)) **Vielen Dank an @knepper & UB Mainz!**
